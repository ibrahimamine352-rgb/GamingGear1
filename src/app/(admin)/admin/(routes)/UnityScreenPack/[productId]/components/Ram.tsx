                ...
                <div className=' p-3 grid grid-cols-6 gap-3 col-span-6'>
                  {motherboardList.map((item) => {
                    return (
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} version="1.1" x="0px" y="0px" viewBox="0 0 44 55" className="fill-current text-[hsl(var(--accent))]" ><g><path  d="M41.9,21H23V2.1c0-0.6-0.5-1-1-1c-0.6,0-1,0.5-1,1V21H2.1c-0.6,0-1,0.5-1,1s0.5,1,1,1H21v18.8   c0,0.6,0.5,1,1,1c0.6,0,1-0.5,1-1V23h18.8c0.6,0,1-0.5,1-1S42.5,21,41.9,21z" /></g></svg>
                    </div> 
                      </>
                    )
                  })}
              ...
              <div className='w-full pb-3 group '>
                {
                 ...
                 {MotherBoardId[ListKey]!= item.id?<>
                  <button type='button' className='w-auto bg-green-500 m-2  text-foreground p-2 rounded-sm' onClick={()=>setMotherBoardId(item.id,ListKey)}> Set Default</button>
                 </>:<>
                 <button   type='button'  className='w-auto bg-red-500 m-2 text-foreground  p-2 rounded-sm' >Default</button>
