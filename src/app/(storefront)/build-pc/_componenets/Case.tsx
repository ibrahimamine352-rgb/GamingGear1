...
export const Case = (props: {
  ...
  return (
    <div className="text-foreground">
                    ...
                    <div className="build-container hover:bg-[#1a1a1a] transition flex md:flex-row flex-col justify-between group items-center rounded-xl space-x-3">
                      ...
                      <div className="flex-shrink-0">
                        <div className="aspect-square mt-3 rounded-xl bg-gray-100 ml-3 dark:bg-transparent relative" style={{ height: '150px' }}>
                          <Image src={props.processorId.images?.[0]?.url} alt="" fill className="aspect-square object-cover rounded-md h-full w-full" />
                        </div>
                      </div>
      ...
      {/* DIALOG — sticky header/footer + dual-pane scroll */}
      {openDialog && ( // ⟵ mount only when open
        <Dialog open={openDialog} onOpenChange={(v) => steOpenDialog(v)}>
          {/* <DialogTrigger asChild /> ⟵ REMOVED */}
          <DialogContent
          ref={dialogLayerRef}
            className="
              w-[95vw] max-w-[1200px]
          ...
          >
            ...
            {/* Body: 12-col grid with independent scrolling panes */}
                             ...
                             checkcompatibility(item) ? "ring-1 ring-[#00e0ff]/50" : "ring-1 ring-red-500/40"}`}>
                              <div>
                                <div className="aspect-square rounded-xl bg-gray-100 dark:bg-transparent relative">
                                  <Image src={item.images?.[0]?.url} alt="" fill className="aspect-square object-cover rounded-md" />
                                </div>
                                <div>
