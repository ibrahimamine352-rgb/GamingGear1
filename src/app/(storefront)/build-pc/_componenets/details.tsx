...
<><li className='font-semibold text-red-500'>*{e.message}</li></>
        ...
        <AlertDialogAction onClick={() => setOpenAleert(false)}>Close</AlertDialogAction>
            ...
            <Popover modal={false}>
                ...
                <PopoverContent className="bg-card border border-border mr-7 mb-0 w-[min(92vw,480px)]">
...
const Btn :React.FC<btnProp>= ({Total,CompNumber}) => {
    return (<>
        ...
        <div className="shadow-md flex flex-row-reverse drop-shadow hover:opacity-100 opacity-90 bg-[hsl(var(--card))] rounded-full p-2 border border-border"
        >
...
-2 4207 -3 0 -2675z"/>
            ...
            <div className='bg-primary text-foreground fixed border rounded-full p-1 w-6 h-6 translate-x-1 -translate-y-3 text-xs'>?</div>
