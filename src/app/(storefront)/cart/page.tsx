        ...
        <div className="px-4 py-16 sm:px-6 lg:px-8 rounded-2xl border border-border bg-card backdrop-blur-sm shadow-[0_0_0_1px_rgba(255,255,255,0.02)] glass-card my-5">
          ...
          <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start gap-x-12">
            <div className="lg:col-span-7">
              {cart.items.length === 0 && <p className="text-foreground/70 text-lg">Your cart is empty.</p>}
              {cart.items.length > 0 && <Button onClick={() => cart.removeAll()} className="bg-gradient-to-r from-[#38BDF8] to-[#0EA5E9] text-black font-semibold hover:shadow-[0_0_20px_rgba(0,224,255,0.3)]">Clear Cart</Button>}
