...
const PackCartItem: React.FC<CartItemProps> = ({
  ...
  return ( 
    <li className="flex py-6 border-b border-border">
      ...
      <div className="relative ml-4 flex flex-1 flex-col justify-between sm:ml-6">
        ...
        <CardContent className="p-0 dark:text-foreground">
        {seeMore ? (
  <>
  ...
  <></>
      ...
      <div onClick={()=>setSeeMore(!seeMore)} className="w-full text-center cursor-pointer font-bold text-sm p-1 text-muted-foreground hover:underline">{seeMore?<>Voir moins</>:<>Voir plus</>}</div>
        </CardContent>
      </Card>
